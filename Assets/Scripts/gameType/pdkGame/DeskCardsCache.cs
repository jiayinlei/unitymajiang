...
public class DeskCardsCache
{
    ...
    { 
        ...
        get 
        {
            ...
            {
                if (i < library.Count - 3)
                {
                    if (library[i].GetCardWeight == library[i + 1].GetCardWeight &&
                        library[i].GetCardWeight == library[i + 2].GetCardWeight)
                    {
                        minWight += (int)library[i].GetCardWeight;
                        minWight *= 3;
                        break;
                    }
                }
    ...
    public void Sort()
    {
        library = CardRules.SortCards(library, true);
    }
}
