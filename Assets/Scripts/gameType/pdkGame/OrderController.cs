...
public delegate void CardEvent(bool arg,bool arg2);
/// <summary>
/// 出牌顺序权限管理
/// </summary>
public class OrderController
{
    ...
    public void Turn()
    {
        ...
        {
            smartCard(biggest == currentAuthority,false);
        }
        else if (currentAuthority == CharacterType.Player)
        {
            ...
            {
                smartCard(biggest == currentAuthority, true);
            }
            else
            {
                activeButton(biggest == currentAuthority,false);
            }
